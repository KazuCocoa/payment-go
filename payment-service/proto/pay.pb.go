...
func (*PayRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pay_e49346150052ac3e, []int{0}
}
...
func (*PayResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_pay_e49346150052ac3e, []int{1}
}
...
type PayManagerClient interface {
	// define a service to handle payment
...
func init() { proto.RegisterFile("proto/pay.proto", fileDescriptor_pay_e49346150052ac3e) }

var fileDescriptor_pay_e49346150052ac3e = []byte{
